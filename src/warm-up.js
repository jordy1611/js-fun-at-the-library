...
var belowTwoHundred = [1, 20, 3, 4, 5, 6, 70, 8, 9, 11, 12, 1];

// Write the code to access the number cllosest to two hundred, using bracket notation.
belowTwoHundred[1]

var max = belowTwoHundred[0];
for (i = 1; i < belowTwoHundred.length; i++) {
  if (max < belowTwoHundred[i]) {
    max = belowTwoHundred[i];
  }
}
 console.log(max);
